...
type MedicalRecordPatientBookPage = {
  appointmentT: AppointmentTableData;
  medicalRecordPatientT: MedicalRecordPatient;
};
export const MedicalRecordPatientBookPage: FC<MedicalRecordPatientBookPage> = ({
  ...
  useEffect(() => {
    setAppointment(appointmentT);
  }, [appointmentT]);
  useEffect(() => {
    setMedicalRecordPatientToView(medicalRecordPatientT);
  }, [medicalRecordPatientT]);
  ...
  useEffect(() => {
    console.log("appointmentT", appointment);
  }, [appointment]);

  return (
    appointment &&
    medicalRecordPatientToView && (
      <>
            ...
            <div className="w-full flex">
              <div className="w-full flex flex-col items-center">
                ...
                <StyledEntry
                  ...
                  confirmationDialogEntryBodyWidth="w-4/6"
                  confirmationDialogEntryBody={`${appointment?.appointmentDateTime
                    ?.split("T")[0]
                    ?.split("-")
                    ?.reverse()
                    ?.join("-")} ${appointment?.appointmentDateTime
                    ?.split("T")[1]
                    ?.substring(0, 5)}`}
                />
                <StyledEntry
