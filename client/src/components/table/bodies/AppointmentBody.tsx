...
export const AppointmentBody: FC<AppointmentBodyProps> = ({
  ...
  return (
    <tr
      ...
      className={`border-b ${
        isPrinting && "font-medium"
      } border-lightMode-borderColor dark:border-darkMode-borderColor odd:bg-lightMode-oddRowTable even:bg-lightMode-evenRowTable odd:dark:bg-darkMode-oddRowTable even:dark:bg-darkMode-evenRowTable transition duration-300 ease-in-out hover:bg-lightMode-hoverRowTable hover:dark:bg-darkMode-hoverRowTable ${
    ...
    >
      ...
      {isPrinting && <td className="px-6 py-4 text-xs"></td>}
      {!isPrinting && (
        <td className="px-6 py-4 text-xs">
